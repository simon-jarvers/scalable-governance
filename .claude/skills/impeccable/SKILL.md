...
allowed-tools:
  - Bash(npx impeccable *)
  - Bash(/home/user/scalable-governance/.claude/skills/impeccable/scripts/impeccable *)
license: Apache 2.0
---
...
**Pin / Unpin:** `/home/user/scalable-governance/.claude/skills/impeccable/scripts/impeccable pin <pin|unpin> <command>` creates or removes a standalone `/<command>` shortcut. Report the script's result concisely; relay stderr verbatim on error.
